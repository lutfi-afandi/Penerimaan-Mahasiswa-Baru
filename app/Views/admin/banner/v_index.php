              ...
              <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          ...
                          <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>/admin/banner"><?php echo $title; ?></a></li>
                      </ol>
                  </div>
              </div><!-- /.row -->
          </div><!-- /.container-fluid -->
                  ...
                  <div class="animated fadeInLeft col-md-12">
                      <div class="card card-fuchsia card-outline">
                          <div class="card-header">
                              <a type="button" class="btn bg-info btn-sm btn-flat" data-toggle="modal" data-target="#addbanner"><i class="fa fa-plus"> </i> Tambah Data </a>
                          </div>
                          <!-- /.card-header -->
                                      ...
                                      <?php
                                        ...
                                        foreach ($banner as $data) { ?>
                                          <tr>
                                              ...
                                              <td><img style="width:200px;" src="<?= base_url('uploads/banner/' . $data['file_gambar']) ?>"> </td>
                                              <td style="text-align:center;">

                                                  <a class="btn btn-danger btn-sm" href="<?php echo base_url('admin/banner/banner_hapus/' . $data['id_banner']); ?>" onclick="return confirm('yakin ingin hapus data ?');"><i class="fa fa-trash"> </i> Hapus </a>
                                              </td>
                                          </tr>
                                      <?php } ?>
                                  </tbody>
      ...
      <div class="modal-dialog modal-dialog-centered ">
          <div class="modal-content">
              ...
              <div class="modal-body text-center">
                  <form class="form-horizontal" action="<?= base_url('admin/banner/add_banner'); ?>" method="post" enctype="multipart/form-data">
