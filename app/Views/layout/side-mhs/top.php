    ...
    <div class="wrapper">
        ...
        <nav class="main-header  navbar navbar-expand bg-gradient-danger navbar-dark p-1 border-bottom-0">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <?php if (session()->get('nama_siswa') == true) { ?>
                    <li class="nav-item">
                    <li class="nav-link"><?= session()->get('nama_siswa'); ?> </li>
                    </li>
                <?php } ?>

                <li class="nav-item ">
                    <a class="nav-link" href="<?= base_url('mahasiswa/auth/logout'); ?>" title="Logout">
        ...
        <aside class="main-sidebar sidebar-light-danger elevation-4">
            <a href="#" class="brand-link text-center">
                <span class="brand-text font-weight-bold" style="font-family: 'arial', cursive;"><strong>BIODATA</strong></span>
            </a>
            <!-- Sidebar -->
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview menu-open">
                            <a href="<?php echo base_url(); ?>/mahasiswa/data" class="nav-link active bg-danger">
                        ...
                        <?php if ($mahasiswa['status'] == 1) { ?>
                            ...
                            <li class="nav-item ">
                                ...
                                <ul class="nav nav-treeview" style="display: block;">
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('mahasiswa/data/berkas'); ?>" class="nav-link">
                                            <i class="far fa-file nav-icon"></i>
                                            <p>Berkas diri</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo base_url('mahasiswa/data/identitas'); ?>" class="nav-link">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                <a href="<?php echo base_url(); ?>/mahasiswa/data/cetak_formulir/<?= $mahasiswa['no_pendaftaran']; ?>" class="nav-link active bg-navy">
                        ...
                        <?php } else {
                            echo '<li class="nav-header text-navy">Menunggu Verifikasi</li>';
                        } ?>


                        <li class="nav-item has-treeview">
                            <a href="<?php echo base_url(); ?>/mahasiswa/auth/logout" class="nav-link">
